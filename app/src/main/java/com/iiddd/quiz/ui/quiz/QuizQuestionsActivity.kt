...
//        progressBar = findViewById(R.id.`@+id/progress_bar`)
//        progressText = findViewById(R.id.`@+id/progress_bar_text`)
//        questionText = findViewById(R.id.`@+id/question_text`)
//        flagImage = findViewById(R.id.`@+id/flag_image`)
...
//        btnSubmitButton = findViewById(R.id.`@+id/submit_button`)
//    }
//
